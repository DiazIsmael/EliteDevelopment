...
<template>
  <div class="mb-4.5">
    <label class="mb-2.5 block text-black dark:text-white"> Account
    ...
    <div class="relative z-20 bg-transparent dark:bg-form-input">
      ...
      >
        ...
        <option v-for="(client) in clients" :key="client.ClientID" :value="client.ClientID">{{ client.Name }}</option>
      </select>
