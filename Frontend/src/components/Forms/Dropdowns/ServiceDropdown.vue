...
<template>
  <div class="mb-4.5">
    <label class="mb-2.5 block text-black dark:text-white"> Service
    ...
    <div class="relative z-20 bg-transparent dark:bg-form-input">
      ...
      >
        ...
        <option v-for="(service) in services" :key="service.ServiceID" :value="service.ServiceID">{{ service.Description }}</option>
      </select>
