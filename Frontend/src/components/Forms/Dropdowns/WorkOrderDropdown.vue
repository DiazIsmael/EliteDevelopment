...
<template>
  <div class="mb-4.5">
    <label class="mb-2.5 block text-black dark:text-white"> Work Order
    ...
    <div class="relative z-20 bg-transparent dark:bg-form-input">
      ...
      >
        ...
        <option v-for="(workorder) in workorders" :key="workorder.WorkOrderID" :value="workorder.WorkOrderID">({{workorder.Date}}) {{workorder.Name}} - {{ workorder.Description }}</option>
      </select>
