...
<template>
  <div class="mb-4.5">
    <label class="mb-2.5 block text-black dark:text-white"> Employee
    ...
    <div class="relative z-20 bg-transparent dark:bg-form-input">
      ...
      >
        ...
        <option v-for="(employee) in employees" :key="employee.EmployeeID" :value="employee.EmployeeID">{{ employee.Name }}</option>
      </select>
