...
import { getClientTypes } from '@/api/api.js'
...
onMounted(loadClientTypes)
</script>

<template>
  <div class="mb-4.5">
    <label class="mb-2.5 block text-black dark:text-white"> Client Type 
    ...
    <div class="relative z-20 bg-transparent dark:bg-form-input">
      ...
      >
        <option value="" disabled selected>Set client type</option>
        <option v-for="(type) in clientTypes" :key="type.ClientCode" :value="type.ClientCode">{{ type.Type }}</option>
      </select>
